	...
	<form name="mf" action="memoEdit" method="post">
		 <table border="1">
			  ...
			  <tr>
			    ...
			    <td width="80%">
			    	<input type="text" name="no" value="${memo.no}" placeholder="No" readonly style="width:40%">
		    	</td>
			  </tr>
			  <tr>
			    <td width="20%">
			    ...
			    <td width="80%">
			    	<input type="text" name="name" value="${memo.name}" placeholder="Name">
		    	</td>
			  </tr>
			  <tr>
			    <td width="20%">
			    ...
			    <td width="80%">
			    	<input type="text" name="msg" value="${memo.msg}" placeholder="Message">
		    	</td>
			  </tr>
			  <tr>
			    <td colspan="2">
