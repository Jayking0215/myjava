	...
	<form name="mf" action="MemoEdit" method="post">
		 <table border="1">
			  ...
			  <tr>
			    ...
			    <td width="80%">
			    	<input type="text" name="no" value="<%=vo.getNo()%>" placeholder="No" readonly style="width:40%">
		    	</td>
			  </tr>
			  <tr>
			    <td width="20%">
			    ...
			    <td width="80%">
			    	<input type="text" name="name" value="<%=vo.getName()%>" placeholder="Name">
		    	</td>
			  </tr>
			  <tr>
			    <td width="20%">
			    ...
			    <td width="80%">
			    	<input type="text" name="msg" value="<%=vo.getMsg()%>" placeholder="Message">
		    	</td>
			  </tr>
			  <tr>
			    <td colspan="2">
