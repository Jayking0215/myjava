 ...
 * Generated at: 2023-04-20 00:18:23 UTC
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      pageContext = _jspxFactory.getPageContext(this, request, response,
      			"/example/error.jsp", true, 8192, true);
	...
	//scope: application은 서버가 시작하고 종료될때까지 객체가 유지된다.
      ...
      out.write('\r');
      out.write('\n');
      user.model.UserVO user = null;
      synchronized (application) {
        user = (user.model.UserVO) _jspx_page_context.getAttribute("user", javax.servlet.jsp.PageContext.APPLICATION_SCOPE);
        if (user == null){
          user = new user.model.UserVO();
 	...
 	String loc=(n>0)?"../login/login.jsp":"javascript:history.back()";
      ...
      out.write(' ');
      out.write("\r\n");
      out.write(" <!-- forward방식으로 이동. 서버내부에서 페이지 이동이 일어나며 이때 같은 request,response를 사용한다.(핵심) -->\r\n");
      out.write("<script>\r\n");
      out.write("	alert('");
      out.print(str);
      out.write("');\r\n");
